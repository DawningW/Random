 ...
 * <p>
 示例使用代码：
 AutoCheck.getInstance(this).check(MainActivity.synthesizerConfig, new Handler()
 {
 @Override
...
public class AutoCheck {
    ...
    public void check(final MySynthesizer.Config config, final Handler handler) {
        Thread t = new Thread(new Runnable() {
            @Override
            public void run() {
                AutoCheck obj = innerCheck(config);
                isFinished = true;
